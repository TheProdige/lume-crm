...
export const EVENT_TYPE_LABELS: Record<string, { en: string; fr: string; icon: string }> = {
  ...
  estimate_sent: { en: 'Estimate sent', fr: 'Soumission envoyée', icon: 'send' },
  estimate_accepted: { en: 'Estimate accepted', fr: 'Soumission acceptée', icon: 'check' },
  estimate_rejected: { en: 'Estimate rejected', fr: 'Soumission refusée', icon: 'x' },
